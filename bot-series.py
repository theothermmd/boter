...
import json
import os
from libs.data import cdn , bearer_token
from libs.func import getAllTitles_series ,get_movie_data
from io import BytesIO
from tqdm import tqdm
from colorama import Fore, Style
if not os.path.isfile('movie_data_series.json'):
    getAllTitles_series()
...
categories = {'irani' : 8851 , 'dubble' : 8 , 'zernevis' : 8791 , 'animations': 8852}

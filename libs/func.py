...
with open('movie_data_series1111111111111111.json', 'w', encoding='UTF-8') as file:
        file.write(json.dumps( get_series_data("e03c4c00-0558-11eb-a37b-85e99d1ea2cc"), ensure_ascii=False))